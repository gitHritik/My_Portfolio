...
const Projects = () => {
    ...
    return (
        <section id="projects" className="ml-[2rem] mr-6 px-10">
            ...
            <div className="space-y-8">
                {projects.map((project) => (
                    <div
                        key={project.id}
                        className="bg-gray-100/30 dark:bg-gray-900/30 border border-gray-300 dark:border-gray-800 rounded-2xl p-6 hover:border-gray-400 dark:hover:border-gray-700 transition"
                    >
                        {/* Project Images */}
                        <div className="mb-6">
                            {project.images ? (
                        ...
                        {/* Project Title */}
                        <h3 className="text-2xl font-semibold mb-3 flex items-center gap-2 text-gray-900 dark:text-white">
                            {project.title}
                            <a
                                href={project.link}
                                target="_blank"
                        ...
                        {/* Project Description */}
                        <p className="text-gray-700 dark:text-gray-400 text-base mb-5 leading-relaxed">
                            {project.description}
                        </p>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {project.techStack.map((tech) => (
                                <span
                                    key={tech}
                                    className="px-3 py-1 bg-gray-200 dark:bg-gray-950 border border-gray-300 dark:border-gray-800 rounded-lg text-sm text-gray-900 dark:text-gray-300"
                                >
                                    {tech}
                                </span>
                            ))}
