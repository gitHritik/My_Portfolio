function Hero() {
    return (
        <section id="home" className="ml-[2rem] mr-6 mt-2 px-10 py-2">
            {/* Main Heading */}
            <h1 className="text-5xl font-bold mb-5 leading-tight text-gray-900 dark:text-white">
            ...
            {/* Bio */}
            <p className="text-gray-700 dark:text-gray-400 text-base mb-10 max-w-4xl leading-relaxed">
            ...
            {/* Stats Grid */}
            <div className="grid grid-cols-3 gap-8 max-w-6xl border-t border-gray-300 dark:border-gray-700 pt-3">
                <div>
            ...
            <div className="grid grid-cols-3 gap-8 max-w-4xl border-t border-gray-300 dark:border-gray-700 mt-3" />
        </section>
    );
}
